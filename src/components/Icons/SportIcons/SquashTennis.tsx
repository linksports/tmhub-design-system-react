...
const SvgSquashTennis: React.FC<IconProps> = (props) => {
  ...
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M6.145 10.36a2 2 0 0 0-2.785.49 2 2 0 0 0 .49 2.785c.905.635 2.15.415 2.785-.49a2 2 0 0 0-.49-2.785m-1.56 1.355c-.26.37-.61.64-1.005.795-.06-.16-.09-.335-.09-.505a1.759 1.759 0 0 0 .99-1.41c.16-.06.335-.09.505-.09-.01.415-.14.84-.4 1.21m1.91.28a1.74 1.74 0 0 0-.99 1.415c-.16.06-.335.09-.505.09a2.25 2.25 0 0 1 1.405-2.01q.09.249.09.505"
        clipRule="evenodd"
      />
    </svg>
  );
};
export default SvgSquashTennis;

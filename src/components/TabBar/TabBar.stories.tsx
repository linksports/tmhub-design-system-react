...
import { sizeValues, TabBarListProps, TabBarProps } from "./TabBar.types";

type TabBarStoryProps = TabBarProps & {
  size: TabBarListProps["size"];
  bordered: TabBarListProps["bordered"];
};

const meta: Meta<TabBarStoryProps> = {
  ...
  argTypes: {
    bordered: {
      control: "boolean",
      description: "選択されていないタブにborderがあるかどうか",
      table: {
...
const Template: StoryFn<TabBarStoryProps> = (args) => (
  <TabBar.Root {...args}>
    <TabBar.List bordered={args.bordered} size={args.size}>

...
const SvgOpponentDoubles: React.FC<IconProps> = (props) => {
  ...
  return (
    ...
    >
      ...
      <g mask="url(#OpponentDoubles_svg__a)">
        ...
        <path
          ...
          mask="url(#OpponentDoubles_svg__b)"
        />
        <circle
          cx={36}
          cy={120}
...
export default SvgOpponentDoubles;

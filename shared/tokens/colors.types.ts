export type Colors = {
  ...
  backgroundTagChipGray: string;
  backgroundTagChipBlue: string;
  backgroundTagChipOrange: string;
  backgroundTagChipGreen: string;
  ...
  borderTagChipGray: string;
  borderTagChipBlue: string;
  borderTagChipOrange: string;
  borderTagChipGreen: string;

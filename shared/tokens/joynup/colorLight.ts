...
export const colorLight: Colors = {
  ...
  backgroundTagChipGray: primitiveColors.BgGray2,
  backgroundTagChipBlue: primitiveColors.JuCyan50,
  backgroundTagChipOrange: primitiveColors.JuOrange50,
  backgroundTagChipGreen: primitiveColors.JuGreen50,
  ...
  borderTagChipGray: addAlpha(primitiveColors.JuNavy, "15%"),
  borderTagChipBlue: primitiveColors.JuCyan50,
  borderTagChipOrange: primitiveColors.JuOrange500,
